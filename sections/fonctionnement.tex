...
<<<<<<< HEAD
La variété des exigences en matière de réseaux a donnée lieu à une classification progressive 
des adresses selon des rôles bien precis. En effet, pas toutes
les adresses IPv4 ont la même signification: à certaines adresses (ou plages
d'adresses) ont été attribué par convention des fonctions particulières.
...
>>>>>>> 6ce11227be102b334a365db7573a00724d3f1744
%TODO (apparition??) 
