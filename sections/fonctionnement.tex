...
adresses IP sous trois aspects differants: on classifiera d'abord les adresses
par leur portee, puis on introduira le concept d'adresse publique et adresse
prive, enfin on parlera des fonctions speciales qui ont ete assigne a certaines
adresses.


\paragraph{Porte des adresses}
La portee d'un adresse ({\it address scope}) represente le nombre de machine
rattrache a cet adresse 
