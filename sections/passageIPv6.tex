...
Lorsque IPV4 a été développé dans les années 70-début des années 80, personne 
...
\subsubsubsection{Fonctionnement du NAT dynamique (Network Adress Translation)}
...
\subsubsubsection{Différents types de NAT}
...
\subsubsubsection{Redirection de port(Port forwarding)}
...
\subsubsubsection{NAT et sécurité}
