...
efficace afin de partager des informations, et faire des
...
Dans un réseau à commutation de circuits chaques périphériques pouvaient utiliser
...
inutilisable pour d'autre transmission vers un destinataire différent (c'est le même
...
\\
Le concept de réseau à paquets commutés a été inventé et mis en 
...
\\
Dans un réseau à commutation de paquets ({\it Packet Switching}), la connexion
...
possibilité d'avoir simultanément plusieurs connexions (envoyer et recevoir
...
Ainsi, il existe plusieurs chemins pour accéder à un noeud et lorsque l'un d'entre eux
