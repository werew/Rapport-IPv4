...
Un autre bit, appelle MF ({\it More Fragment}), indique si le paquet est suivi 
...
reserve pour applications possibles futures.
\footnote {
...
%Memo: unique difference entre dernier fragment et paquet pas fragmente est un offset > 0%
